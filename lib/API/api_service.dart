  ...
  Future<ModelUser?> addUser(ModelUser user) async {
    try {
      ...
      if (response.statusCode == 201 || response.statusCode == 200) {
        ...
        return null; // Email benar-benar ada
      } else {
        throw "Server error: ${response.statusCode}";
      }
    } catch (e) {
      // Melempar error agar masuk ke blok 'catch' di RegisterPage
      throw "Gagal terhubung ke Docker. Cek CORS atau koneksi jaringan.";
    }
  }
